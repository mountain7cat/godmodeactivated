...
typedef struct mob_node mob_node_t;

/*** DEFINE THE mob_t TYPE HERE ***/
/*** use a typedef and any struct definitions you need ***/
typedef struct{
	int num;			// number of the monster_t
	mob_node_t *head;
} mob_t;
...
/*** DEFINE THE mob_iterator_ty TYPE HERE ***/
typedef struct { 
	int count;
	mob_node_t *node;
} mob_iterator_t;
